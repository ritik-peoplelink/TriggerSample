...
export async function watchStream() {
    ...
    try {
        ...
        console.log("Change Stream DB Connected");
...
async function monitorListingsUsingEventEmitter(client, timeInMs = 60000) {
    const collection = client.db("StreamTest").collection("stores");
    ...
    // Trigger your events or actions based on the change
    if (next.operationType === 'insert') {
      console.log('Document inserted:', next.fullDocument);
      // Trigger your insert event handling here
    } else if (next.operationType === 'update') {
      console.log('Document updated:', next.fullDocument);
      // Trigger your update event handling here
    } else if (next.operationType === 'delete') {
      console.log('Document deleted:', next.documentKey);
      // Trigger your delete event handling here
    }
    });
